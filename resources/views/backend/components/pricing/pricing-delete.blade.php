    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-end">
                ...
                <button onclick="pricingDelete()" type="button" id="confirmDelete" class="btn btn-danger">
                    Delete
                </button>
            </div>
        </div>
...
<script>
   async function pricingDelete() {
    ...
    try {
        ...
        const response = await axios.post("/pricing-delete", { id: deleteID });
