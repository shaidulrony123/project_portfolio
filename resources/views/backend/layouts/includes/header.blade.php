...
{{-- <link id="theme-style" rel="stylesheet" href="{{asset('backend/assets/css/progress.css')}}"> --}}
<link rel="stylesheet" href="{{asset('backend/assets/css/sweetalert2.min.css')}}">

	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="{{ asset('backend/assets/sass/dark-theme.css') }}">
	<link rel="stylesheet" href="{{ asset('backend/assets/sass/semi-dark.css') }}">
	<link rel="stylesheet" href="{{ asset('backend/assets/sass/bordered-theme.css') }}">
